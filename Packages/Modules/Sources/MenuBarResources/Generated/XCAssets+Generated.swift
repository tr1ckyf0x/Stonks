...
public enum Asset {
  public enum Logo {
    ...
    public static let bnb = ImageAsset(name: "bnb")
    public static let ethereum = ImageAsset(name: "ethereum")
    public static let litecoin = ImageAsset(name: "litecoin")
    public static let luna = ImageAsset(name: "luna")
    public static let monero = ImageAsset(name: "monero")
    ...
    public static let twt = ImageAsset(name: "twt")
  }
}
